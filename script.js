...
// username : hs, pin :3333
// username : ar, pin :4444
...
const account3 = {
  owner: 'Hiroyuki Sanada',
  movements: [1200, 1450, -908, 5000, -6140, 163.9, 677, -400],
  interestRate: 1.6, // %
  pin: 3333,
...
const account4 = {
  owner: 'Amin Rostami',
  movements: [
    1200000, 1450000, -98000, 5000000, -6140000, 163000, 677000, -400000,
  ],
  interestRate: 1.6, // %
  pin: 4444,
...
const displayMovements = function (acc, sort = false) {
  ...
  combinedMovements.forEach(function (obj, i) {
    ...
    const display = formatMovementDate(date, acc.locale);
